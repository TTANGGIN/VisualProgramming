...
BEGIN_MESSAGE_MAP(CLineDlg, CDialogEx)
	...
	ON_WM_PAINT()
	ON_WM_QUERYDRAGICON()
	ON_BN_CLICKED(IDC_BUTT_DRAW, &CLineDlg::OnBnClickedButtDraw)
	ON_BN_CLICKED(IDC_BUTT_CLEAN, &CLineDlg::OnBnClickedButtClean)
END_MESSAGE_MAP()
...
void CLineDlg::OnBnClickedButtDraw()
{
...
void CLineDlg::OnBnClickedButtClean()
{
	// TODO: 여기에 컨트롤 알림 처리기 코드를 추가합니다.
	Invalidate(TRUE);
}
