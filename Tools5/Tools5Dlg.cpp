...
CTools5Dlg::CTools5Dlg(CWnd* pParent /*=nullptr*/)
	: CDialogEx(IDD_TOOLS5_DIALOG, pParent)
{
...
void CTools5Dlg::OnSysCommand(UINT nID, LPARAM lParam)
{
...
//  이 함수를 호출합니다.
HCURSOR CTools5Dlg::OnQueryDragIcon()
{
